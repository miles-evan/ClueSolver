...
The clueSolvingAlgorithm.ClueGame class takes user input to simulate a game by communicating with the clueSolvingAlgorithm.clueSolvingAlgorithm class.
The input can refer to cards by their numbers or the first 2 letters.

The clueSolvingAlgorithm.clueSolvingAlgorithm class holds an instance of clueSolvingAlgorithm.Hands and clueSolvingAlgorithm.ClueLogic to hold the information we know.
...
The clueSolvingAlgorithm.ClueBacktracker holds the same instance of clueSolvingAlgorithm.Hands and clueSolvingAlgorithm.ClueLogic as the clueSolvingAlgorithm.clueSolvingAlgorithm class does.
...
If it's impossible to set an entry to a check, for example, then the clueSolvingAlgorithm.clueSolvingAlgorithm class would set that entry to an X.\

The clueSolvingAlgorithm.Hands class holds the table of checks and Xs.
...
The clueSolvingAlgorithm.ClueLogic class just holds the information for each player of what cards they could have.
